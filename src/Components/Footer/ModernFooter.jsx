...
const ModernFooter = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/subashpradhan',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      href: 'mailto:contact@subashpradhan.com',
      icon: (
      ...
      <div className="max-width-container section-padding py-12">
                ...
                <li key={link.name}>
                  <a
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-blue-600
                             dark:hover:text-blue-400 transition-colors text-sm"
                  >
                    {link.name}
                  </a>
                </li>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-lg flex items-center
                           justify-center hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600
                           hover:text-white text-gray-700 dark:text-gray-400 transition-all duration-300
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              © {currentYear} Subash Pradhan. All rights reserved.
            </motion.p>
